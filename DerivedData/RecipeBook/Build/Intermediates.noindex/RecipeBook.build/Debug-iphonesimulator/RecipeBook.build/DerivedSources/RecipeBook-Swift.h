...
#ifndef RECIPEBOOK_SWIFT_H
#define RECIPEBOOK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RecipeBook",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10RecipeBook11AppDelegate")
...
SWIFT_CLASS("_TtC10RecipeBook13SceneDelegate")
...
SWIFT_CLASS("_TtC10RecipeBook14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIPickerView * _Null_unspecified DName;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified Ingredients;
@property (nonatomic, weak) IBOutlet UIPickerView * _Null_unspecified Process;
- (void)viewDidLoad;
...
@interface ViewController (SWIFT_EXTENSION(RecipeBook)) <UIPickerViewDataSource>
...
@interface ViewController (SWIFT_EXTENSION(RecipeBook)) <UIPickerViewDelegate>
